...
def main():
    ...
    with st.spinner("Loading prices + running engines…"):
        ...
        try:
            d["internals"] = INT.run_internals(us)   # V40-ported: breadth, market mode, change detection
        except Exception:
            d["internals"] = {}
    ...
    with tabs[2]:                       # RISK timing: panic/fear-greed/crash-lead/valuation + market internals
